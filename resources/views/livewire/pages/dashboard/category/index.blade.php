<div>
                                        ...
                                        @foreach ($categories as $category)
                                            <tr>
                                                ...
                                                <td class="relative py-4 pl-3 pr-4 space-x-2 text-sm font-medium text-right whitespace-nowrap sm:pr-0">
                                                    <button type="button" wire:click="$dispatch('editCategory', {category: '{{ $category->id }}'})" class="text-gray-600 hover:text-gray-900">Edit</button>
                                                    <button type="button" wire:click="$dispatch('deleteCategory', {category: '{{ $category->id }}'})" class="text-red-600 hover:text-red-900">Delete</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
    ...
    <livewire:pages.dashboard.category.form-modal />
    <livewire:pages.dashboard.category.delete-modal />
</div>
